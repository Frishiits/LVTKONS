   ...
   <section class="u-align-center u-clearfix u-gradient u-section-1" id="carousel_1d8f">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto text-center">
            <h1 class="display-6"> Pievienot Konsultaciju</h1>
        </div>
    </div> <!-- End -->
    <div class="row">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            <form role="form" onsubmit="event.preventDefault()">
                                <div class="form-group"> <label for="username">
                                        <h6>Vārds uzvārds</h6>
                                    </label> <input type="text" name="username" placeholder="Vārds uzvārds" required class="form-control "> </div>
                                <div class="form-group"> <label for="cardNumber">
                                        <h6>Konsultacijas nosaukums</h6>
                                    </label>
                                    <div class="input-group"> <input type="text" name="cardNumber" placeholder="Nosaukums" class="form-control " required>
